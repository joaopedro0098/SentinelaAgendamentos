...
function isPatientAuthEntry(search: string) {
  const params = new URLSearchParams(search);
  return params.get("role") === "patient" || params.has("activation_token");
}
...
export function BarberPwaEntryRedirect() {
  ...
  if (location.pathname === "/login" && isPatientAuthEntry(location.search)) return null;
