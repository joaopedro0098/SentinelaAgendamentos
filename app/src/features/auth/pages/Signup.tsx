...
export default function Signup() {
  ...
  useEffect(() => { document.title = "Teste grátis 14 dias — Sentinela Agendamentos"; }, []);
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center p-6 bg-chat-app-bg">
      <Link to="/" className="flex items-center gap-2 mb-6">
        ...
        <span className="font-semibold text-lg">Sentinela Agendamentos</span>
      </Link>
      <Card className="w-full max-w-sm">
        <CardHeader>
          <CardTitle>Teste grátis por 14 dias</CardTitle>
          <CardDescription>
            Crie sua conta e comece a atender pelo chat. Sem cartão neste período de teste.
          </CardDescription>
        </CardHeader>
