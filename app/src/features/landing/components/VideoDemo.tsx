...
import { LANDING_DEMO_VIDEO_SRC } from "@/lib/landingDemoVideo";
  ...
  return (
    <div className={cn("relative group w-full", className)}>
      ...
      <div className="relative glass rounded-3xl overflow-hidden glow-border">
        <div className="aspect-[9/16] w-full relative bg-secondary/40">
          <video
            controls
            playsInline
            preload="metadata"
      ...
      <p className="sr-only">Vídeo de demonstração do Sentinela Agendamentos</p>
    </div>
  );
}
