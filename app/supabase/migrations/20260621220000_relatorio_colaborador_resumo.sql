-- Resumo de faturamento e horas no detalhe do relatório por colaborador.
...
COMMENT ON FUNCTION public.get_relatorio_detalhes_colaborador(date, date, uuid) IS
  'Lista agendamentos confirmados de um colaborador no período com resumo de faturamento e horas.';
