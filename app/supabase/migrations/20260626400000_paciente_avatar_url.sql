-- Foto do paciente (avatar_url em clientes), editável na aba Pacientes → Dados cadastrais.

ALTER TABLE public.clientes
  ADD COLUMN IF NOT EXISTS avatar_url text;

COMMENT ON COLUMN public.clientes.avatar_url IS
  'URL pública da foto do paciente (storage), editável na aba Pacientes.';
