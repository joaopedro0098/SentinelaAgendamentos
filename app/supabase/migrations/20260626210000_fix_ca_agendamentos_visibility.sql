-- Garante que agendamentos de CA apareçam para CT mesmo com barbeiro inativo/ausente.
...
COMMENT ON FUNCTION public.get_agendamentos_painel(date, date) IS
  'Painel: CT/AA vê própria barbearia + CAs; LEFT JOIN barbeiro evita ocultar agendamento se colaborador inativo.';
