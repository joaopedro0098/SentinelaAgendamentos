...
export function GoogleButton({ label = "Continuar com Google" }: { label?: string }) {
  ...
  async function handleClick() {
    ...
    toast({
      ...
      description: "Verifique as URLs de redirecionamento do Supabase Auth para este domínio.",
      variant: "destructive",
    });
  }

  return (
    <Button type="button" variant="outline" className="w-full h-11" onClick={handleClick} disabled={loading}>
